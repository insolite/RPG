...
class __declspec(dllexport) CGUIButton :
	public IGUIButton
{
public:
	bool Dragging;
	...
	CGUIButton(IGUIEnvironment* environment, IGUIElement* parent, s32 id, core::rect<s32> rectangle, CurrentGameObject<GameObject>* currentGameObject, bool noclip = false);
	~CGUIButton(void);
